<?php
    ...
    if (isset($_POST['submit'])) {
        ...
        $result = mysqli_query($conn, "UPDATE users SET name='$name', user_name='$uname', password='$password' WHERE id=$id");
        if ($result) {
    ...
    <div class="container py-5"> 
        ...
        <form class="col col-sm-5 col-lg-6 col-md-7" action="" method="POST">
            ...
            <div class="mb-3">
                ...
                <input type="text" name="uname" placeholder="Username" value="<?= $row['user_name']?>" class="form-control">
            </div>
            <div class="mb-3">
